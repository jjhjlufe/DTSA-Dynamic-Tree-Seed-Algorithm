...
void sphere_func (double *, double *, int , double *,double *, int, int); /* Sphere 1*/
void ellips_func(double *, double *, int , double *,double *, int, int); /* Ellipsoidal 2 */
void bent_cigar_func(double *, double *, int , double *,double *, int, int); /* Discus 3*/
void discus_func(double *, double *, int , double *,double *, int, int);  /* Bent_Cigar 4*/
void dif_powers_func(double *, double *, int , double *,double *, int, int);  /* Different Powers5*/
void rosenbrock_func (double *, double *, int , double *,double *, int, int); /* Rosenbrock's 6*/
void schaffer_F7_func (double *, double *, int , double *,double *, int, int); /* Schwefel's F7 7*/
void ackley_func (double *, double *, int , double *,double *, int, int); /* Ackley's 8*/
void rastrigin_func (double *, double *, int , double *,double *, int, int); /* Rastrigin's 9 */
void weierstrass_func (double *, double *, int , double *,double *, int, int); /* Weierstrass's 10 */
void griewank_func (double *, double *, int , double *,double *, int, int); /* Griewank's  11*/
void schwefel_func (double *, double *, int , double *,double *, int, int); /* Schwefel's 12*/
void katsuura_func (double *, double *, int , double *,double *, int, int); /* Katsuura 13*/
void bi_rastrigin_func (double *, double *, int , double *,double *, int, int); /* Lunacek Bi_rastrigin 14*/
void grie_rosen_func (double *, double *, int , double *,double *, int, int); /* Griewank-Rosenbrock  15*/
void escaffer6_func (double *, double *, int , double *,double *, int, int); /* Expanded Scaffer¡¯s F6  17*/
void step_rastrigin_func (double *, double *, int , double *,double *, int, int); /* Noncontinuous Rastrigin's  18*/
void happycat_func (double *, double *, int , double *,double *, int, int); /* HappyCat 19*/
void hgbat_func (double *, double *, int , double *,double *, int, int); /* HGBat  20*/
